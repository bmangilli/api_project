...
API Project é uma API Restful simples de gerenciamento de tarefas desenvolvido com Laravel. Ele permite que os usuários listem, visualizem, criem, atualizem e excluam tarefas.
